...
public enum ConfigKey {
    ...
    L1D_SIZE("L1D_SIZE"),
    L1I_SIZE("L1I_SIZE"),
    L1D_BLOCK_SIZE("L1D_BLOCK_SIZE"),
    L1I_BLOCK_SIZE("L1I_BLOCK_SIZE"),
    L1D_ASSOCIATIVITY("L1D_ASSOCIATIVITY"),
    L1I_ASSOCIATIVITY("L1I_ASSOCIATIVITY"),
    L1D_PENALTY("L1D_PENALTY"),
    L1I_PENALTY("L1I_PENALTY"),
