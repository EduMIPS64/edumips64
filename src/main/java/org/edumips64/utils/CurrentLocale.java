...
public class CurrentLocale {
  ...
  static {
    ...
    zhcn.put("ReportDialog.MSG", "EduMIPS64致命错误！<br/>请通过在 GitHub 上<a href='https://github.com/EduMIPS64/edumips64/issues/new'>建立一个新 Issue</a>并附上以下文本，或者通过发送电子邮件到<a href='mailto:bugs@edumips.org'>bugs@edumips.org</a>来帮助开发人员。");
