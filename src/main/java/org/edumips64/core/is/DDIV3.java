/** DDIV3.java
 *
 * Instruction DDIV (three-operand form) of the MIPS64 Instruction Set
 ...
 *              
 *              Note: This is the MIPS64 Release 6 three-operand version of DDIV.
 *              For the legacy two-operand form that stores results in LO/HI,
 *              use the regular DDIV rs, rt syntax.
 *</pre>
 * @author EduMips64 project
 */
class DDIV3 extends ALU_RType {
  ...
  DDIV3() {
    ...
    name = "DDIV";  // Keep name as DDIV for display purposes
  }
