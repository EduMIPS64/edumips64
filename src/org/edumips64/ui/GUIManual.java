...
public class GUIManual extends JDialog {
	...
	private void setTextAreaFile(String filename, JTextArea jta) {
		BufferedReader r = new BufferedReader(new InputStreamReader(org.edumips64.Main.class.getResourceAsStream(filename)));
		String temp;
		try{
	...
	*/
	...
	class Intestazione extends JPanel{
		public void paintComponent(Graphics g){
			...
			g.setFont(f1);
			g.drawString("v." + org.edumips64.Main.VERSION ,290,50);
			
			f1 = new Font("Times New Roman", Font.ITALIC, 20); 
			//JLabel jl3=new JLabel("  UserGuide");
			g.setFont(f1);
			g.drawString(org.edumips64.utils.CurrentLocale.getString("Manual.CAPTION"),20,80);
		}
	}
