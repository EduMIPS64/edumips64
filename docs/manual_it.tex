...
open:           daddi       r14, r0, params_sys1    
                ...
                #include    print.s      
\end{lstlisting}
Inizialmente vengono salvati in memoria i dati richiesti dalla \SC{} 1 (righe 6,
7), cio\'e la stringa contenente il path del file da aprire (che deve esistere),
...
Successivamente (righe 2, 4) si salvano in memoria (e gli si assegna
...
da passargli l'indirizzo di 'error\_op' nel caso in cui r1 sia uguale a $-1$ (riga
18).  Altrimenti si chiama la stessa funzione facendo in modo di
passargli l'indirizzo di 'ok\_message' (riga 16).
...
Passando alla sezione .text,essa contiene una funzione che: 
 inizialmente salva l'indirizzo di params\_sys5,
...
la stringa desiderata. Alla fine viene restituito il controllo alla funzione chiamante
