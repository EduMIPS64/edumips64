...
\begin{itemize}
	...
	Effettua uno shift verso sinistra del registro a 64-bit rt, di un numero di bit indicati nel valore immediato sa, 
	e pone il risultato in rd. I bit liberi vengono posti a zero.

	\index{DSLLV}
	\index{istruzioni!DSLLV}
	\item \texttt{DSLLV rd, rs, rt}\\
	Effettua uno shift verso sinistra del registro a 64-bit rt, di un numero di bit specificato nei 6 bit bassi del registro rs, 
	e pone il risultato in rd. I bit liberi vengono posti a zero.

	\index{DSRA}
	\index{istruzioni!DSRA}
	\item \texttt{DSRA rd, rt, sa}\\
	Effettua uno shift verso destra del registro a 64-bit rt, di un numero di bit specificato nel valore immediato sa, 
	...
	Effettua uno shift verso sinistra del registro a 32-bit rt, di un numero di bit indicati nel valore immediato sa, 
	...
	Effettua uno shift verso sinistra del registro a 32-bit rt, di un numero di bit specificato nei 5 bit bassi del registro rs, 
	e pone il risultato nel registro a 32-bit rd. I bit liberi vengono posti a zero.

	\index{SRA}
	\index{istruzioni!SRA}
	\item \texttt{SRA rd, rt, sa}\\
	Effettua uno shift verso destra del registro a 32-bit rt, di un numero di bit specificato nel valore immediato sa, 
	...
	Effettua uno shift verso destra del registro a 32-bit rt, di un numero di bit specificato nei 5 bit bassi del registro rs,
	...
	Effettua uno shift verso destra del registro a 32-bit rt, del numero di bit specificato nei 5 bit bassi del registro rs, 
	e pone il risultato nel registro a 32-bit rd. I bit liberi vengono posti a zero.
