...
Version~1.1, 22nd of April 2007
\end{minipage}}
...
\begin{itemize}
	...
	immediate value sa, and puts the result into 64-bits register rd. Empty bits are padded with
	zeros.

	\index{DSLLV}
	\index{instructions!DSLLV}
	\item \texttt{DSLLV rd, rt, rs}\\
	Does a left shift of 64-bits register rt, by the amount specified in low-order 6-bits of rs,
	...
	Does a right shift of 64-bits register rt, by the amount specified in the immediate value sa,
	...
	Does a right shift of 64-bits register rt, by the amount specified in low-order 6-bits of rs,
	and puts the result into 64-bits register rd. Empty bits are padded with zeros if the leftmost bit
	of rt is zero, otherwise they are padded with ones.
	...
	Does a right shift of 64-bits register rs, by the amount specified in the immediate value sa,
	and puts the result into 64-bits register rd. Empty bits are padded with zeros.
	...
	Does a left shift of 32-bits register rt, by the amount specified in the immediate value sa,
	...
	Does a left shift of 32-bits register rt, by the amount specified in low-order 5-bits of rs,
	and puts the result into 32-bits register rd. Empty bits are padded with zeros.

	\index{SRA}
	\index{instructions!SRA}
	\item \texttt{SRA rd, rt, sa}\\
	Does a right shift of 32-bits register rt, by the amount specified in the immediate value sa,
	...
	Does a right shift of 32-bits register rt, by the amount specified in low-order 5-bits of rs,
	and puts the result into 32-bits register rd. Empty bits are padded with zeros if the leftmost bit
	of rt is zero, otherwise they are padded with ones.
	...
	Does a right shift of 32-bits register rs, by the amount specified in the immediate value sa,
	and puts the result into 32-bits register rd. Empty bits are padded with zeros.
