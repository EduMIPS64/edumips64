...
\begin{table}[!htb]
	\begin{centering}
		\begin{tabular}{ll}
			...
			31 & \texttt{ra}\\
		\end{tabular}
		\caption{MIPS32 register aliases}
...
\begin{itemize}
	...
	Executes the division between rs and rt, considering them as unsigned values
    and putting the quotient in LO and the
	remainder in HI.
	...
	Executes the multiplication between rs and rt, considering them as unsigned
    values and putting the result in LO.
